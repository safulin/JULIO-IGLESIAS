      ...
      <div class="layout">
        ...
        <main class="main-container">
          ...
          <section class="map-area">
            <div class="real-map">
              <l-map ref="mapRef" :zoom="14" :center="[41.395, 2.180]" :useGlobalLeaflet="false">
                <l-tile-layer url="https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png" />
                
                <l-polyline :lat-lngs="routeCoords" color="#E63946" :weight="8" />
                ...
                <l-marker v-for="(label, index) in labels" :key="'label-' + index" :lat-lng="label.position">
                  ...
                  <l-tooltip :options="{ permanent: true, direction: 'top', offset: [0, -10] }" class="google-tooltip-fixed">
                    <div class="google-label">
                      <ion-icon :icon="busOutline" class="mode-icon"></ion-icon>
...
import { busOutline, chevronBackOutline } from "ionicons/icons";
...
const modoSeleccionado = ref('bus');
...
const routeCoords = ref([
  [41.385, 2.173], [41.395, 2.180], [41.405, 2.185], [41.410, 2.190]
]);

const labels = ref([
  { position: [41.395, 2.180], time: "12 min", dist: "3,2 km" },
  { position: [41.410, 2.190], time: "18 min", dist: "4,5 km" },
]);
</script>
